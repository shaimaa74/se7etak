...
export const ROUTES: RouteInfo[] = [
  ...
  },
  {
    ...
    title: 'Services',
    type: 'link',
    icontype: 'ni ni-bullet-list-67 text-orange',
  },
  {
    path: '/tests',
    title: 'Tests',
    type: 'link',
    icontype: 'ni ni-check-bold text-info',
  },
  {
    path: '/paymentMethods',
    title: 'Payment Methods',
    type: 'link',
    icontype: 'ni ni-money-coins text-yellow', 
  },
  {
    path: '/coupons',
    title: 'Coupons',
    type: 'link',
    icontype: 'ni ni-credit-card text-purple', 
  },
  {
    path: '/FAQs',
    title: 'FAQs',
    type: 'link',
    icontype: 'ni ni-ruler-pencil text-primary', 
  },
  {
    path: '/geo',
    title: 'Geographical Information ',
    type: 'sub',
    icontype: 'ni ni-square-pin text-pink',
    collapse: 'geo',
    isCollapsed: true,
    children: [
      { path: 'countries', title: 'Country', type: 'link' },
      { path: 'cities', title: 'Cities', type: 'link' },
      { path: 'areas', title: 'Areas', type: 'link' },
    ],
  },
  // {
  //   path: "/examples",
